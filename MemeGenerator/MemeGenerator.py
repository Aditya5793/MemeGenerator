...
class MemeEngine():
    ...
    def make_meme(self, img_path, text, author, width=500):
        ...
        font1 = ImageFont.truetype("./_data/fonts/FreeMono.ttf", 45)
        font2 = ImageFont.truetype("./_data/fonts/FreeMono.ttf", 35)
        ...
        draw.text((70, text_position + 45), f"- {author}", fill, font2)
